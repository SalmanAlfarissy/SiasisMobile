 ...
 * Use the {@link SppFragment#newInstance} factory method to
...
public class SppFragment extends Fragment {
    ...
    public static SppFragment newInstance(String param1, String param2) {
        SppFragment fragment = new SppFragment();
